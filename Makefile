...
$(OBJECT): lex.yy.o  yacc.tab.o Interpreter.o Graph.o
	$(CC) $(CPP_FLAGS) lex.yy.o yacc.tab.o Interpreter.o Graph.o -o $(OBJECT)
# @./$(OBJECT) #编译后立刻运行
...
Interpreter.o: Interpreter.cpp Interpreter.hpp Graph.hpp yacc.tab.h Utils.hpp
