...
@string_tmp_.3 = private unnamed_addr constant [10 x i8] c"Ni hao a \00", align 1
...
main_entry:
  ...
  %2 = call i32 (i8*, i32, ...) @print(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @string_tmp_.3, i32 0, i32 0), i32 %tmp1)
