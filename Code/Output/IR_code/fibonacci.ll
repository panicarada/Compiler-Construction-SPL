...
main_entry:
  ...
  %record_access_tmp_ = getelementptr inbounds { i32, i32 }, { i32, i32 }* %info, i32 0, i32 1
  ...
  %record_access_tmp_3 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %info, i32 0, i32 1
  %4 = load i32, i32* %record_access_tmp_3, align 4
...
fibo:
  ...
  %record_access_tmp_ = getelementptr inbounds { i32, i32 }, { i32, i32 }* %1, i32 0, i32 1
  %record_access_tmp_2 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %1, i32 0, i32 1
  %2 = load i32, i32* %record_access_tmp_2, align 4
  %iadd_tmp_ = add i32 %2, 1
  store i32 %iadd_tmp_, i32* %record_access_tmp_, align 4
...
if:                                               ; preds = %fibo
  ...
  %record_access_tmp_5 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %1, i32 0, i32 0
  %fibo6 = load i32, i32* %fibo1, align 4
  store i32 %fibo6, i32* %record_access_tmp_5, align 4
  br label %after
  ...
  %record_access_tmp_11 = getelementptr inbounds { i32, i32 }, { i32, i32 }* %1, i32 0, i32 0
  %fibo12 = load i32, i32* %fibo1, align 4
  store i32 %fibo12, i32* %record_access_tmp_11, align 4
  br label %after
