...
namespace Graph
{
        ...
        int& Col_Mid) // 绘制前后Col的中点
    {
        ...
        case NodeType::Constant:
            ...
            {
            case ConstantType::Integer: sText << p->m_Constant.iValue; break;
            case ConstantType::Real: sText << p->m_Constant.dValue; break;
            case ConstantType::Char: sText << "'" << (char)p->m_Constant.cValue << "'"; break;
            case ConstantType::String: sText << "\"" << p->m_Constant.sValue << "\""; break;
            case ConstantType::Boolean: sText << (p->m_Constant.bValue ? "true" : "false"); break;
            default:
                std::cout << "Invalid Constant Type: " << p->m_Constant.Type << "!" << std::endl;
                exit(1);
            }
            sText << ")";
            break;
        ...
        // 如果node is leaf
        if (p->m_Type == NodeType::Constant ||
            p->m_Type == NodeType::Identifier ||
            p->m_Type == NodeType::Typename ||
